...
def SistemaHormigasElitista(semillas, archivo):
    xs = []
    ys = []
    ...
    print("SISTEMA DE HORMIGAS ELITISTAS")
    print(archivo)
    ...
    for semilla in semillas:
        ...
        while tf < 300:
            ...
            for i in range(1, len(solFinal)):
                c1 = int(solFinal[i - 1])
                c2 = int(solFinal[i])
                matrizFeromonas[c1, c2] += (e / costeFinal)
                matrizFeromonas[c1, c2] = np.array(matrizFeromonas[c1, c2]).copy()
