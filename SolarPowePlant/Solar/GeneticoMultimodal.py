...
def geneticoMultimodal(semillas=np.random.randint(-999, 999, size=5), nClearing=10, distanciaMinima=8, nIndividuos=25,
...
def estudioParametros(semillas, nClearing=10, distanciaMinima=8, nIndividuos=25):
    costes = []
    tiempos = []
